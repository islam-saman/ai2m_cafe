...
function displayProduct(){
    ...
    for (const p of prdList) {
        productContainer += `
         <div class='box col-12 col-md-3' style="width:18rem" onclick='addOrder(${p.id})'> 
            <input class='prdId' name='prdId' type='hidden' value=${p.id} />
            <div class='image'>
                <a style='cursor:pointer;'> 
                    <img class='w-100' style='height:150px;'  src="../../${p.image}" alt='${p.id}'>
        ...
        orderContainer += `
                        <tr scope="row" id="${orderArray[prd].product['id']}">
                           ...
                           <td class="d-flex">
                               ...
                               <input class=""  type="number" id="ordQun${orderArray[prd].product['id']}" value="${orderArray[prd].quantity}" style="width:30px;padding:0px;text-align:center;" name="quantity"/>
                               <a onclick="decreaseOrderQuantity(${orderArray[prd].product['id']}, ${prd['price']})" class="btn decrease-button btn-danger">-</a>
                           </td>
                ...
                let newOrder = `
                       <tr id="${prd['id']}">
                           ...
                           <td class="d-flex">
                               ...
                               <input  class="" type="number" id="ordQun${prd['id']}" value="1" style="width:30px;padding:0px;text-align:center;" name="quantity"/>
